...
(function () {
  ...
  // Performance Optimization: Defer the initial layout-dependent reads (offsetTop)
  // using requestAnimationFrame to prevent a Forced Synchronous Layout (FSL)
  // pass during the initial HTML parsing/rendering critical path.
